...
class Config:
    ...
    # OpenClaw Proxy 配置
    OPENCLAW_PROXY_URL: str = "http://192.168.0.149:18887/v1"  # OpenClaw Proxy 端口
    OPENCLAW_API_KEY: Optional[str] = "sk-proxy"  # Proxy 不需要真实 key
    ...
    QDRANT_USE_MEMORY: bool = True  # 默认使用内存存储
    
    # 群聊参数
    DEFAULT_GROUP_ID: str = "default"
    ROUND_TIMEOUT_SECONDS: int = 300  # 轮次超时
    QUALITY_THRESHOLD: float = 0.5    # 质量阈值
    MAX_CONSECUTIVE_SPEAKS: int = 2   # 最大连续发言
