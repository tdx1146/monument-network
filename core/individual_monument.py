...
class IndividualMonument:
    ...
    def from_dict(cls, data: dict[str, Any]) -> "IndividualMonument":
        ...
        # 初始化 _config 和 _min_confidence，防止 AttributeError
        monument._config = Config.get_instance()
        monument._min_confidence = monument._config.get("scoring.min_confidence", 0.8)
        return monument
